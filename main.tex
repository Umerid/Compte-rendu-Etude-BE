...
Les résultats sont plutôt concluants pour les cannelures à flancs parallèles. Cependant, Les cannelures à flancs parallèles ne sont pas parfaitement adaptées pour des vitesses de rotation très élevées du fait que l'alignement ne soit pas parfait. 
...
\begin{itemize}
    ...
    \item Couple transmissible : $C = p A L \frac{d1+d2}{4} = \frac{p Ndents L}{8} (d2^2 - d1^2)$.
\end{itemize}
Nous retrouvons rapidement que la longueur minimale de la cannelure à flancs en développante est égale à 
\[ L >= \frac{8 C}{Ndents.(d2^2 - d1^2). Padm}\]

Afin d'ajuster au mieux les dimensions des différentes cannelures, nous nous sommes appuyés sur le tableau de calcul du livre mécanique "Guide du dessinateur industriel" de M. Chevalier publié en 1969.

\begin{center}
\includegraphics[width=0.6\textwidth]{guide_dessin_indus_cannelure_dev.jpg}
\captionof{figure}{Tableau de dimensionnement des cannelures à flancs en développante - "Guide du dessinateur industriel", M.Chevalier, 1969}
\end{center}
...
Lors du dimensionnement, nous avons vérifié qu'il n'y ait pas de collision entre nos différents composants. \\Vous trouverez ci-dessous le tableau récapitulatif.
...
\captionof{figure}{Schéma d'un arbre avec des entretoises}
\end{center}
...
En effet nous n'avions pas remarqué que l'énoncé de l'exercice précisait que le démarreur devait entraîner la turbine jusqu'à puissance nominale démarreur (5500 tr/min) puis être débrayé. Au moment du débrayage, l'arbre d'entrée E doit avoir une vitesse de rotation au quart de sa vitesse nominale.
...
\\Un tel écart de vitesse de rotation rend obligatoire de rajouter un arbre intermédiaire afin de respecter le critère de dimensionnement en rapport de réduction (compris entre 0,5 et 2).
...
\hline
ARBRE & Vitesse de rotation (rpm) & Vitesse de rotation (rads-1) & Couple (Nm) \\ \hline
Arbre Entrée & 2500 & 261,80 & 779,22 \\ \hline
Arbre Démarreur & 5500 & 575,96 & 354,19 \\ \hline
Arbre Intermédiaire E-D & 4000 & 418,88 & 487,01 \\ \hline
\end{tabular}%
}
\end{table}
...
\captionof{figure}{Schéma cinématique de la nouvelle configuration}
\end{center}
...
\hline
DIAMÈTRE & Diamètre mini (mm) & Diamètre min (Pire des cas) \\ \hline
Arbre Entrée & 40,97 & 41,11 \\ \hline
Arbre Démarreur & 31,50 & 31,61 \\ \hline
Arbre Intermédiaire E-D & 35,03 & 35,15 \\ \hline
\end{tabular}%
}
\end{table}
...
Dans la suite du dimensionnement de notre relais d'accessoires, nous avons étudié les géométries pour les cannelures. Comme nous avons pu voir que les cannelures à flancs en développante sont plus adaptées par rapport aux cannelures à flancs parallèles et aux clavettes, nous avons décidé d'étudier uniquement les cannelures à flancs en développante.
...
\begin{tabular}{|l|l|l|l|l|l|l|}
\hline
CANNELURES & A (mm) & m (module) & N (nombre de dents) & D (diamètre primitif) & A’ (Diamètre extérieur ) & L mini (mm) \\ \hline
Arbre Entrée & 60 & 2,5 & 22 & 55 & 59,5 & 9,08 \\ \hline
Arbre Démarreur & 50 & 2,5 & 18 & 45 & 49,5 & 6,12 \\ \hline
Arbre Intermédiaire E-D & 55 & 2,5 & 20 & 50 & 54,5 & 6,84 \\ \hline
\end{tabular}%
}
\end{table}
...
Après avoir étudié les arbres et les cannelures, nous avons continué notre étude de dimensionnement avec les engrenages. Nous avons adapté les rayons de nos engrenages de façon à respecter les vitesses de rotations au démarrage et aussi à respecter les écarts entre les différents composants. Vous trouverez ci-dessous les nouvelles dimensions pour les engrenages.
...
\begin{tabular}{|l|l|l|l|l|l|l|l|}
\hline
ENGRENAGES & module & Largeur (mm) & Rayon engrenage (mm) & nb dents & Diamètre engrenage & Vitesse de rotation & Erreur (\%) \\ \hline
Arbre Entrée & 3 & 30 & 75 & 50 & 150 & 5 507,66 & 0,139324277255318 \\ \hline
Arbre Intermédiaire E-D 1 & 3 & 30 & 54 & 36 & 108 & 3 965,52 &  \\ \hline
Arbre Intermédiaire E-D 2 & 2 & 20 & 46 & 46 & 92 & 3 965,52 & -0,862068965517233 \\ \hline
Arbre Démarreur & 2 & 20 & 29 & 29 & 58 & 2 500,00 &  \\ \hline
\end{tabular}%
}
\end{table}
...
Pour finir le dimensionnement de notre relais d'accessoires, nous avons chercher quels sont les roulements adaptés pour chacun de nos arbres. Pour cette nouvelle version de notre relais d'accessoires, nous avons fait l'hypothèse que la charge se répartit uniformément sur les deux roulements pour chacun de nos arbres. Vous pourrez trouver ci-dessous les charges statiques et dynamiques et aussi les roulements choisis pour chaque arbre.
...
\begin{tabular}{|l|l|l|l|l|l|l|}
\hline
ROULEMENTS & P (N) & C (N) & Roulement à billes & C\_Max\_Indi (kN) & Quantité & C\_Max\_Collectif (kN) \\ \hline
Arbre Entrée & 12 605,06 & 84 382,42 & 6309 & 55,3 & 2 & 110,6 \\ \hline
Arbre Démarreur & 7 366,59 & 64 137,89 & 6307 & 35,1 & 2 & 70,2 \\ \hline
Arbre Intermédiaire E-D & 8 862,93 & 69 394,41 & 6208 ETN9 & 35,8 & 2 & 71,6 \\ \hline
\end{tabular}%
}
\end{table}

Concernant les entretoise, nous avons décidé de nous inspirer ce que nous avons effectué avec la première version du relais d'accessoires.


\begin{center}
\includegraphics[width=0.75\textwidth]{Solution_cannelures.png}
\captionof{figure}{Vue en côté d'un arbre avec les roulements et les entretoises}
\end{center}
\newpage
\subsection{Modélisation sur CATIA}
...
\captionof{figure}{Vue en perspective avec un zoom}
\end{center}

\begin{center}
\includegraphics[width=0.85\textwidth]{Vue_3D_sans_carter.PNG}
\captionof{figure}{Vue en perspective avec un zoom et sans carter}
\end{center}

\begin{center}
\includegraphics[width=0.85\textwidth]{vue_coupe_BE_E_I.PNG}
\captionof{figure}{Vue en coupe du relais d'accessoires}
\end{center}
\end{spacing}
\end{document}
