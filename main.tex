...
Du fait que les vitesses de rotation sont différentes lors du démarrage du relais d'accessoires, nous avons refait les calculs des couples pour chaque arbre.
...
Du fait qu'il n'y a que la partie dédiée au démarreur et à la génératrice est la seule partie modifiée, nous avons de récupérer l'ancienne conception du relais d'accessoires.

Vous trouverez ci-dessous la nouvelle structure de notre relais d'accessoires.
\begin{center}
\includegraphics[width=0.75\textwidth]{schema_V2.jpg}
\captionof{figure}{Schéma de la nouvelle configuration}
\end{center}
...
Comme pour notre première étude du relais d'accessoires, nous avons commencé notre montage par le dimensionnement de nos différents arbres. Nous avons repris les équations que nous avons utilisé pour l'ancienne version du relais d'accessoires. Vous trouverez ci-dessous les nouveaux diamètres des arbres. 
